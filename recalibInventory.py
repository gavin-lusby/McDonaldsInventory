# Manager update for resetting values of items in inventory
# This is used in case employees forget to log a removed item or the updated inventory is otherwise incorrect/out-of-date and requires a manual recount and reset
